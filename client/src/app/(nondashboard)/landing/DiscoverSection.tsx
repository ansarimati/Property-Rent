          ...
          {[
            {
              ...
              description: "Browses through our extensive collection of rental properties in your desired location."
            },
            {
              imageSrc: "/landing-icon-calendar.png",
              title: "Book Your Rental",
              description: "Once you found the perfect rental property, easily book online with just few clicks."
            },
                        {
